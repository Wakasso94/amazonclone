        ...
        <div className="home">
            <div className="home__container">
                ...
                <div className="home__row">
                    <Product 
                    id="12321341"
                    title="Lean Startup: embrace continuous innovation paperback - july 3, 2015" 
                    price={29.99}
                    rating={5}
                ...
                <div className="home__row">
                    ...
                    <Product 
                        ...
                        price={98.99}
                        rating={5}
                        image="https://media.very.co.uk/i/very/P6LTG_SQ1_0000000071_CHARCOAL_SLf?$300X400_retinamobilelex2$.jpg"
                    />
                    <Product 
                        id="3254354345"
