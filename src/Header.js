    ...
    <div className="header">
        <Link to='/'>
            <img
                ...
                src="https://pngimg.com/uploads/amazon/amazon_PNG25.png" alt="logo_header"
            />
        </Link>

        <div className="header_search">
            <input className="header_searchInput" type="text" />
            <SearchIcon className="header_searchIcon" alt="search" />
        </div>
        
        <div className="header_nav">
            <Link to={!user && '/login'}>
                <div onClick={handleAuthentification} className="header_option">
                    <span className="header_optionLineOne">Hello Wakasso</span>
